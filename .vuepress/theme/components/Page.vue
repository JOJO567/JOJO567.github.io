<template>
  <main class="page" :style="pageStyle">
    ...
    <ModuleTransition delay="0.20">
        <div class="end">
          <p class="endbg"><em><span>END</span></em></p>
          <p><strong style="color:var(--text-color);">❤️ 感谢您的耐心阅读！</strong></p>
          <p>
            <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh" target="_blank" rel="nofollow">
              <i class="fa fa-creative-commons" style="color:#999;font-size:14px;"> 知识共享署名-非商业性使用-相同方式共享 4.0 国际许可协议</i>
            </a>
          </p>
        </div>
    </ModuleTransition>
...
export default {
  ...
  computed: {
    ...
    lastUpdated () {
      ...
      if (this.$themeConfig.lastUpdated === false) return false
