  ...
  <div class="home-blog">
        ...
        <div class="motto">
          ...
          <ModuleTransition delay="0.04">
            <h1 v-if="recoShowModule && $frontmatter.heroText !== null" class="longcang">
              {{ motto.zh || $frontmatter.heroText || $title || "野猿新知著" }}
            </h1>
          </ModuleTransition>

          <ModuleTransition delay="0.08">
            <p v-if="recoShowModule && $frontmatter.tagline !== null" class="description">
              <!-- {{ motto.en || $frontmatter.tagline || $description || 'Welcome to suyan site' }} -->
              <AutoInput iid="description" :des=" motto.en || $frontmatter.tagline || $description || '欢迎来我的小站'" />
            </p>
          </ModuleTransition>
          <a href="#anchor" class="scroll-down bounce-enter-active down-arrow"></a>
        </div>
      <component v-if="bubbles" :is="bubbles" :options="options" style="pointer-events: none;"></component>
    </div>
    ...
    <ModuleTransition delay="0.16">
      <div id="anchor" v-show="recoShowModule" class="home-blog-wrapper">
        ...
        <div class="info-wrapper wow animate__animated animate__zoomIn">
          <PersonalInfo />
...
export default {
  ...
  computed: {
    ...
    motto() {
      return this.$themeConfig.mottos[(Math.floor(Math.random()*7))] || {
      ...
      const initBgImageStyle = {
        ...
        background: `
          url(${
            ...
            : this.$themeConfig.covers[(Math.floor(Math.random()*13))]
